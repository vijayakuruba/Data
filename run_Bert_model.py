...
def model_train_validate_test(train_df, dev_df, test_df, target_dir, 
    ...
    for epoch in range(start_epoch, epochs + 1):
        ...
        if patience_counter >= patience:
            ...
            break
    print(epochs_count, train_losses, train_accuracies, valid_losses, valid_accuracies)
    return epochs_count, train_losses, train_accuracies, valid_losses, valid_accuracies 
